...
# ============================================================================
    ...
    st.markdown('<div class="main-header">✈️ Flight Delay Prediction</div>', unsafe_allow_html=True)
...
# ============================================================================
    ...
    st.markdown('<div class="main-header">📊 Batch Flight Predictions</div>', unsafe_allow_html=True)
